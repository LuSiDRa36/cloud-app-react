...
import bgImg from '../assets/images/pexels-tima-miroshnichenko-5380649.jpeg'
                 ...
                 mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200
                  borderborder-slate-300 rounded-xl text-center shadow-xl'>
                    ...
                    <div className='flex justify-between flex-wrap px-2'>
                        ...
                        <p className='flex px-4 py-2 text-slate-500'><DatabaseIcon className='h-6 text-sky-600' />Dashboard Design</p>
